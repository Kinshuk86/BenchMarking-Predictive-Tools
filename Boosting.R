...
d_train$Month <- as.factor(d_train$Month)
d_train$DayofMonth <- as.factor(d_train$DayofMonth)
d_train$DayOfWeek <- as.factor(d_train$DayOfWeek)
d_train$UniqueCarrier <- as.factor(d_train$UniqueCarrier)
d_train$Month <- as.factor(d_train$Month)
